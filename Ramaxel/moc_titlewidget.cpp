...
QT_MOC_LITERAL(1, 12, 9), // "showsetwg"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "closewindow"

    },
    "TitleWidget\0showsetwg\0\0closewindow"
};
...
void TitleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleWidget::showsetwg)) {
                *result = 0;
                return;
            }
        }
