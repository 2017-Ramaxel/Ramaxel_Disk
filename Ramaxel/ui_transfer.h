...
public:
    ...
    void setupUi(QWidget *Transfer)
    {
        ...
        upload_scroll->setGeometry(QRect(0, 0, 761, 518));
        ...
        download_scroll->setGeometry(QRect(0, 0, 761, 518));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 761, 518));
        ...
        clearBtn->setStyleSheet(QString::fromUtf8("color: rgb(85, 170, 0);\n"
"font: 8pt \"\346\226\260\345\256\213\344\275\223\";"));
